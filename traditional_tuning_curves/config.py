...
# Plotting
PLOT_MAX_NEURONS = 10
REBUILD_PAIRED_POLAR_PLOTS = os.getenv("TRADITIONAL_REBUILD_PAIRED_POLAR", "0") == "1"
EQUALIZE_POLAR_AREA = os.getenv("TRADITIONAL_EQUALIZE_POLAR_AREA", "1") == "1"
RESCORE_MODE = os.getenv("TRADITIONAL_RESCORE_MODE", "scores").lower()
